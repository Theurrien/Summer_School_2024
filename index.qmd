...
![](/header_home.png){fig-align="center"}
...
Die Forschung zeigt, dass eine optimale Lichtintensität (200-400 Lux), Temperatur (22-24°C) und kontrollierte CO~2~-Konzentration die Produktivität [@coleyEffectLowVentilation2007], Testergebnisse [@toftumAssociationClassroomVentilation2015] und das Wohlbefinden der Schüler\*innen positiv beeinflussen können [@krawczykIndoorEnvironmentLighting2022; @bogdanovicaEffectCO2Concentration2020; @toyinboBuildingCharacteristicsIndoor2016]. Darüber hinaus hat sich gezeigt, dass ein übermässiger Lärmpegel den Lernprozess stört [@toyinboBuildingCharacteristicsIndoor2016] und sowohl die unterrichteten Personen als auch möglicherweise die Lehrpersonen in ihrer Fähigkeit beeinträchtigt, sich zu konzentrieren und effektiv zu arbeiten [@GreenSchoolsAttributes2006]. Angesichts dieser Erkenntnisse soll in dieser Arbeit untersucht werden, wie sich diese Umweltfaktoren auf den psychologischen und emotionalen Zustand der Lehrpersonen und damit auf ihre Wahrnehmung und Interaktion mit den Studierenden auswirken.
